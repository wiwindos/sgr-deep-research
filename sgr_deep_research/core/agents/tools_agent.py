...
from sgr_deep_research.core.tools.base import BaseTool, system_agent_tools
...
async def main():
    agent = ToolCallingResearchAgent(
        task="Research the current state of Tesla's Full Self-Driving technology in 2025. I need to understand if Tesla has achieved Level 5 autonomous driving as Elon Musk promised it would be ready by 2024, and whether regulatory approval has been granted worldwide."
    )
    # agent = ToolCallingResearchAgent(task="Сравни цену на биткоин за 2023 и 2024 год")
    await agent.execute()
